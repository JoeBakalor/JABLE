...
public class JABLENew: NSObject{
    ...
    public override init() {
        ...
        centralController = CBCentralManager(delegate: self, queue: nil, options: [CBCentralManagerOptionShowPowerAlertKey: true])
    }
}
...
extension JABLENew: JABLEapi{
    ...
    public func startLookingForPeripherals(withServiceUUIDs uuids: [CBUUID]?) {
        ...
        guard let validUUIDs = uuids
                ...
                centralController?.scanForPeripherals(
                    withServices: nil,
                    options: [CBCentralManagerOptionShowPowerAlertKey: true, CBCentralManagerScanOptionAllowDuplicatesKey: false])
            return
            }
    ...
    public func write(value: Data, toDescriptor descriptor: CBDescriptor) {
